...
<head>
	...
	<title>Job Express - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Job Express" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> KHARAR, <br/> DGM HOMES, <br/>JHUNGIA ROAD</address>
								</li>
								<li>
										<h5>Email</h5><a href="demongs001@gmail.com">demongs001@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+7727012747">+7727012747</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Job Express</h5>
											<p>Job Express is a job portal, online job management system developed by Gourav Sharma for his project in MAY 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : KHARAR DGM HOMES</p>
								<p>Email : <a href="demongs001@gmail.com">demongs001@gmail.com</a></p>
								<p>Phone : <a href="tel:+7727012747">+7727012747</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> jOB EXPRESS Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Gourav Sharma</a></li>
								</ul>
