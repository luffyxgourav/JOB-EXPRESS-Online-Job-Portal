					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> DGM Homes, <br/> Janta Nagar, <br/>Kharar</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:nightingale.nath2@gmail.com">CareerHub@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+233 546 607 474">+91 7021542226</a>
								</li>
								...
								<li>
										...
										<div class="contact-social">
											...
											<a href="<?php echo "https://www.facebook.com/yashika.tomar.338"; ?>" data-toggle="tooltip" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a>
											<a href="<?php echo "https://twitter.com/i/flow/login"; ?>" data-toggle="tooltip" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a>
											<a href="<?php echo "https://www.instagram.com/shreshthii/"; ?>" data-toggle="tooltip" data-placement="top" title="Instagram"><i class="fa fa-instagram"></i></a>
